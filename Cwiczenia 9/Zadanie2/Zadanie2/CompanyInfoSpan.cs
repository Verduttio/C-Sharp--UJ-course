...
namespace Zadanie2
{
    class CompanyInfoSpan
    {
        ...
        private StackPanel colorChange;

        private Random rnd = new Random();

        public CompanyInfoSpan(string name, double rate, double change, Label labelRate, Label labelChange, StackPanel color)
        {
            Name = name;
            Rate = rate;
            Change = change;
